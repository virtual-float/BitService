...
# ^[0-9]{1,3}\.?|[0-9]{3}\.[0-9]{0-3}\.?|[0-9]{3}\.[0-9]{3}\.[0-9]{0,3}|$
# ^[0-9]{0,3}|[0-9]{3}\.|[0-9]{3}\.[0-9]{0,3}|[0-9]{3}\.[0-9]{3}\.|[0-9]{3}\.[0-9]{3}\.[0-9]{0,3}$
...
def question(name: str) -> wn.window:
    _window = wn.window(name=name, size=(400,250), body=wn.windowBody(
        ...
        .setRegex('^[0-9]{0,3}|[0-9]{3}\.|[0-9]{3}\.[0-9]{0,3}|[0-9]{3}\.[0-9]{3}\.|[0-9]{3}\.[0-9]{3}\.[0-9]{0,3}$'),
